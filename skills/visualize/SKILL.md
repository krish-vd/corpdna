...
Example: /corpdna:visualize Infosys
Example: /corpdna:visualize Tata Motors FY23"

Otherwise, invoke the `corpdna` subagent with `$ARGUMENTS` (company name,
and optional target year). The subagent should:
